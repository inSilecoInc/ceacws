...
list(
  tar_target(bibtex_master, bibtex_master(), format = "file", cue = tar_cue(mode = "always")),
    ...
    }, format = "file"), tar_target(tg_40932a82_3ecd_476f_b320_40b128b9a4d5_fisheries_study_area_aoi, 
    {
        prc_aoi_fisheries(output_path = "workspace/data/harvested/aoi-1.0.0/processed", 
            input_files = list())
        c("workspace/data/harvested/aoi-1.0.0/processed/aoi_fisheries.gpkg", 
        "workspace/data/harvested/aoi-1.0.0/processed/grid_fisheries.tif"
        )
    }, format = "file")),
    list(list(tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_Documentation, 
    {
        ...
        googleCloudStorageR::gcs_get_object(object_name = "Documentation_Versiontotale.xlsx", 
    ...
    }, format = "file")), list(tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_Codes_engins, 
    {
        googleCloudStorageR::gcs_auth("workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        Sys.setenv(GCS_AUTH_FILE = "workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        googleCloudStorageR::gcs_get_object(object_name = "Codes_engin.csv", 
    ...
    }, format = "file")), list(tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_Codes_espèces, 
    {
        googleCloudStorageR::gcs_auth("workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        Sys.setenv(GCS_AUTH_FILE = "workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        googleCloudStorageR::gcs_get_object(object_name = "Codes_especes.csv", 
    ...
    }, format = "file")), list(tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_Logbooks_20102014, 
    {
        googleCloudStorageR::gcs_auth("workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        Sys.setenv(GCS_AUTH_FILE = "workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        googleCloudStorageR::gcs_get_object(object_name = "Version_totale_20102014.csv", 
    ...
    }, format = "file")), list(tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_Logbooks_20002004, 
    {
        googleCloudStorageR::gcs_auth("workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        Sys.setenv(GCS_AUTH_FILE = "workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        googleCloudStorageR::gcs_get_object(object_name = "Version_totale_20002004.csv", 
    ...
    }, format = "file")), list(tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_Logbooks_20152019, 
    {
        googleCloudStorageR::gcs_auth("workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        Sys.setenv(GCS_AUTH_FILE = "workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        googleCloudStorageR::gcs_get_object(object_name = "Version_totale_20152019.csv", 
    ...
    }, format = "file")), list(tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_Logbooks_20052009, 
    {
        googleCloudStorageR::gcs_auth("workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        Sys.setenv(GCS_AUTH_FILE = "workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        googleCloudStorageR::gcs_get_object(object_name = "Version_totale_20052009.csv", 
    ...
    }, format = "file")), list(tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_Logbooks_20202024, 
    {
        googleCloudStorageR::gcs_auth("workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        Sys.setenv(GCS_AUTH_FILE = "workspace/credentials/pof-stac-insileco-5d20b0cb59ef.json")
        googleCloudStorageR::gcs_get_object(object_name = "Version_totale_20202024.csv", 
    ...
    }, format = "file")), tar_target(tg_fe466272_993d_4b90_b036_bf418c38a63f_fisheries_logbook, 
    {
        prc_fisheries_dfo(output_path = "workspace/data/harvested/fisheries_dfo-1.0.0/processed", 
            input_files = list(tg_fe466272_993d_4b90_b036_bf418c38a63f_Codes_engins, 
        ...
        c("workspace/data/harvested/fisheries_dfo-1.0.0/processed/gear.csv", 
    ...
    {
        ana_fisheries_intensity(output_path = "workspace/data/analyzed/fisheries_intensity-1.0.0", 
            input_files = list(tg_fe466272_993d_4b90_b036_bf418c38a63f_fisheries_logbook, 
