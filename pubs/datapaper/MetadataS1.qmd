...
**Authors**: David Beauchesne^1\*^, Kevin Cazelles^1^, Stephanie Avery-Gomm^2^, April Hedd^3^, Philippe Muise^4^, Allison Patterson^5^, Robert Ronconi^6^, Katharine Studholme^7^, Sarah Wong^6^
...
^4^Environment and Climate Change Canada, National Environmental Emergencies Centre, Montreal, Québec, Canada
...
^6^Environment and Climate Change Canada, Science and Technology Branch Wildlife and Landscape Science Directorate, Dartmouth, Nova-Scotia, Canada

^7^Environment and Climate Change Canada, Science and Technology Branch Wildlife and Landscape Science Directorate, Dartmouth, Nova-Scotia, Canada
...
Mapping anthropogenic threats in the northwest Atlantic to Inform Marine Conservation and Management
...
- Philippe Muise
  ...
  - Environment and Climate Change Canada, National Environmental Emergencies Centre 
...
The study focuses on Canada’s Exclusive Economic Zone (EEZ), including the Atlantic Ocean, the Gulf of St. Lawrence, and adjacent international waters (xmin: -80; ymin: 40; xmax:-40; ymax: 70.9; EPSG:4326). The study area encompasses diverse marine habitats critical to numerous marine species such as migratory seabirds and spans over 5 million km2. The area features high levels of industrial and maritime activity, making it a key region for assessing the cumulative effects of anthropogenic threats on marine ecosystems. Data layers were analyzed within a standardized 1-km2 resolution grid.

### 2. Experimental or sampling design

This project integrates diverse primary datasets to generate spatiotemporal threat layers for Canada’s Exclusive Economic Zone (EEZ) and adjacent international waters (xmin: -80; ymin: 40; xmax:-40; ymax: 70.9; EPSG:4326). The overarching process involves three key phases: 1) data acquisition, 2) data processing and 3) threat layer preparation:
...
2. **Data Processing:** All datasets underwent a standardized processing pipeline to harmonize formats, spatial projections, and temporal resolutions. Key steps included:
   - **Spatial Filtering:** Clipping data to the defined study area using a bounding box (xmin: -80; ymin: 40; xmax:-40; ymax: 70.9) and ensuring alignment with the WGS84 coordinate reference system (EPSG:4326).
...
#| tbl-cap: "Description of AIS shipping data attributes"
data.frame(
  Column_Name = c(
  ...
  Description = c(
    ...
    "Specific vessel subtype, providing further detail on the ship's function, such as 'Passenger Ship' or 'Fishing Vessel'.",
...
3. Spatial Filtering
   - The dataset was filtered to detections within a bounding box approximating the Canadian Exclusive Economic Zone (EEZ), which was broader than the bounding box used for this project and intented to limit the quantity of data processed:
     - **Longitude**: -85° to -35°.
     - **Latitude**: 38° to 75°.
