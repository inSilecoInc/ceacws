...
- Dataset Descriptor: File names specifying temporal (e.g., month/year) and sub-category details (e.g., vessel type or spill type), where applicable.
...
3. Units of Measurement:  
   - Radiance (nW/cm²/sr for VIIRS datasets), density (vessels/km²), and pollution volume (liters for NEEC dataset), presence/absence.  
4. Data Type:  
