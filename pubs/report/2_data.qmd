...
The intensity and distribution of commercial fisheries were assessed using logbook data from the [Department of Fisheries and Oceans (DFO)](https://www.dfo-mpo.gc.ca/). The dataset, compiled from Zonal Interchange File Format (ZIFF) data between 2000 and 2020, provides a thorough overview of fisheries in eastern Canada [@dfo2021b]. This dataset includes information on vessel identifiers, species caught, landing weights, and fishing effort, making it a valuable resource for fisheries analysis (see @tbl-fisheries-dfo-attr). 
